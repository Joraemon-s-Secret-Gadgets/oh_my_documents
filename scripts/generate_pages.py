...
DOCUMENTS = [
    ...
    Document(
        ...
        "UI/UX Guide",
        "로브 (Lovv) — UI/UX 가이드",
        "저장 일정 상세 화면과 관리자 콘솔 권한 승인 화면의 구성, 상태, 접근성 규칙을 정의합니다.",
        "초안",
        "검증·운영 문서",
    ),
    Document(
        ...
        "Test Plan",
        "로브 (Lovv) — 테스트 계획서",
        "Agent 평가, API E2E, 관리자 MFA·고위험 승인, 배포 검증 범위와 실행 기준을 정의합니다.",
        "초안",
        "검증·운영 문서",
    ),
    Document(
        "docs/11_deployment_ops/11_deployment_ops.md",
        "11_deployment_ops.html",
        "Deployment & Operations",
        "로브 (Lovv) — 배포·운영 가이드",
        "배포, 관리자 보안 운영, 로컬 DB 초기화, migration, 검증 절차를 정의합니다.",
        "초안",
        "검증·운영 문서",
    ),
    Document(
