...
docs/95_aha_moment/        Aha Moment 설계와 화면별 보조 문서
docs/96_market_research/   시장 조사와 경쟁 서비스 분석
...
├── 09_ui_ux_guide/09_ui_ux_guide.md
├── 10_test_plan/10_test_plan.md
├── 11_deployment_ops/11_deployment_ops.md
├── 92_B2C/92_B2C.md
├── 93_B2B/93_B2B.md
├── 94_kick/94_kick.md
...
- `pages/*.html`은 `scripts/generate_pages.py`의 `DOCUMENTS`에 등록된 대표 Markdown을 바탕으로 생성한다.
