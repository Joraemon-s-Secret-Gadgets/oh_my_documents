...
> 문서 버전: v0.6
> 문서 상태: 검토 중 (Review)
> 기준 문서: 요구사항 명세서 v1.7, 서비스 흐름 명세서 v0.2, 데이터 수집 계획서 v0.7, 데이터베이스 설계 명세서 v0.6, 기술 명세서 v0.4, API 명세서 v0.3
...
| 버전 | 날짜 | 작성자 | 변경 내용 |
| --- | --- | --- | --- |
| v0.6 | 2026-06-12 | llm팀 | 그래프DB 직접 도입 대신 Lambda 관계 탐색 보조 기능으로 Candidate Evidence 검색 계약 조정 |
