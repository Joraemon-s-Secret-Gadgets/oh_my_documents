...
작성일: 2026-06-08
기준 문서: `../../pages/07_api_spec.html`
기준 버전: API Spec v0.2, Planning
문서 제목 기준: 로브 (Lovv) — API 명세서 v0.2
목적: 현재 PoC 프론트엔드 흐름을 Product API 계약으로 전환할 때 필요한 API 명세 요약과 보강점을 정리한다.
...
### 4.5 추천 API request/response 세부 정합성 보강
