...
| 보조 문서 | 범위 | 상태 |
| --- | --- | --- |
| `candidate_evidence_search_test_plan.md` | Candidate Evidence Agent의 도시 및 관광지 검색 테스트 계획 | Review |
| `candidate_evidence_evaluation_results.md` | Baseline Simple RAG와 Candidate Evidence Agent Ours 비교 결과 | Review |
...
| 우선순위 | 항목 | 기준 문서 |
| --- | --- | --- |
| P1 | Planner 일정 생성 테스트 계획 | `../05_agent_spec/planner_agent.md`, `../05_agent_spec/itinerary_flow.md` |
| P1 | API 추천·저장 E2E 테스트 계획 | `../07_api_spec/07_api_spec.md` |
| P2 | Festival Verifier 날짜·출처 검증 테스트 | `../05_agent_spec/festival_verifier_agent.md` |
