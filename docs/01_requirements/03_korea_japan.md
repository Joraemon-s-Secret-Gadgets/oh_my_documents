    ...
    <style>
      ...
      *::after {
      ...
      .hero-grid {
        ...
        inset: 0;
        background-image:
          linear-gradient(rgba(46, 207, 170, 0.04) 1px, transparent 1px),
          linear-gradient(90deg, rgba(46, 207, 170, 0.04) 1px, transparent 1px);
      ...
      .hero-badge {
        ...
        border: 0.5px solid rgba(46, 207, 170, 0.3);
        padding: 6px 16px;
        border-radius: 100px;
        margin-bottom: 2rem;
      ...
      .pipe-icon.teal {
        ...
        border-color: rgba(46, 207, 170, 0.4);
      }
      .pipe-icon.purple {
        background: rgba(166, 140, 247, 0.12);
        border-color: rgba(166, 140, 247, 0.4);
      }
      .pipe-icon.amber {
      ...
      .pipe-tag.teal {
        background: rgba(46, 207, 170, 0.15);
        color: var(--accent-teal);
      }
      .pipe-tag.purple {
        background: rgba(166, 140, 247, 0.15);
      ...
      .stag.teal {
        color: var(--accent-teal);
        border-color: rgba(46, 207, 170, 0.3);
        background: rgba(46, 207, 170, 0.08);
      }
      .stag.coral {
        color: var(--accent-coral);
        border-color: rgba(240, 112, 88, 0.3);
        background: rgba(240, 112, 88, 0.08);
      }
      .stag.blue {
        color: var(--accent-blue);
      ...
      .stag.purple {
        color: var(--accent-purple);
        border-color: rgba(166, 140, 247, 0.3);
        background: rgba(166, 140, 247, 0.08);
      }
