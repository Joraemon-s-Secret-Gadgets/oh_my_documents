...
.tag.accent { border-color: rgba(232,96,122,.3); color: var(--accent); background: rgba(232,96,122,.07); }
.tag.green  { border-color: rgba(80,200,160,.3); color: var(--green); background: rgba(80,200,160,.07); }
.tag.blue   { border-color: rgba(96,144,224,.3); color: var(--blue); background: rgba(96,144,224,.07); }
...
.drama-badge {
  font-family: var(--mono); font-size: 10px; letter-spacing: .04em;
  background: rgba(232,96,122,.12); border: 1px solid rgba(232,96,122,.25);
...
.field-ex.high { color: #50c8a0; border-color: rgba(80,200,160,.3); background: rgba(80,200,160,.07); }
.field-ex.mid  { color: #d8902a; border-color: rgba(216,144,42,.3); background: rgba(216,144,42,.07); }
.field-ex.low  { color: #e8607a; border-color: rgba(232,96,122,.3); background: rgba(232,96,122,.07); }
...
.step-circle {
  ...
  background: rgba(232,96,122,.12); border: 1px solid rgba(232,96,122,.3);
...
/* ── NOTICE ── */
.notice {
  background: rgba(216,144,42,.07); border: 1px solid rgba(216,144,42,.2);
...
.p-critical { background: rgba(232,96,122,.12); border: 1px solid rgba(232,96,122,.25); color: var(--accent); }
.p-high     { background: rgba(80,200,160,.1);  border: 1px solid rgba(80,200,160,.2);  color: var(--green); }
.p-mid      { background: rgba(96,144,224,.1);  border: 1px solid rgba(96,144,224,.2);  color: var(--blue); }
.p-ref      { background: rgba(216,144,42,.1);  border: 1px solid rgba(216,144,42,.2);  color: var(--amber); }
...
<section id="notice">
  ...
  <div style="margin-top:24px;display:grid;grid-template-columns:repeat(3,1fr);gap:12px;">
    <div style="background:var(--bg2);border:1px solid rgba(80,200,160,.2);border-radius:10px;padding:20px;">
    ...
    <div style="background:var(--bg2);border:1px solid rgba(216,144,42,.2);border-radius:10px;padding:20px;">
    ...
    <div style="background:var(--bg2);border:1px solid rgba(232,96,122,.2);border-radius:10px;padding:20px;">
