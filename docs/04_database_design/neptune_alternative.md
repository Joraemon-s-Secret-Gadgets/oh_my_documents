...
> 문서 버전: v0.1
> 문서 상태: 검토 중 (Review)
> 기준 문서: 데이터베이스 설계 명세서 v0.5, 데이터 수집 계획서 v0.7, Agent 명세서 v0.4, API 명세서 v0.1
...
- 1.2절 설계 기준 표 `Graph DB / AWS Neptune` 비고: "예산 제약상 보류, Neptune 대체 설계 명세서 적용, 고도화 단계 도입".
- 1.3절 저장소 책임 표 Neptune 행: "상시 비용 발생, Neptune 대체 설계 명세서 우선".
- 3.5·4.6절: "PoC/Prod 1차 대체 구현은 Neptune 대체 설계 명세서를 따른다" 각주.
