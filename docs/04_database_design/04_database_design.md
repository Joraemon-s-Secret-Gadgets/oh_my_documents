...
> 매핑 테이블·raw PII는 어느 저장소에도 넣지 않고 별도 KMS·IAM, actorId=가명. 상세: `../98_prd/interactive_builder_prd.md`, 보존/TTL 라인: 보조 문서 `database_design_retention_neptune_update.md` §0.
